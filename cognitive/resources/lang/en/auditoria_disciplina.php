...
return [
    ...
    'created'            => [
        ...
        'modified' => [
            ...
            'idarea' => 'ID Área: <strong>:new</strong>',
            'disciplina' => 'Disciplina: <strong>:new</strong>',
        ],
    ],
    ...
    'updated'            => [
        ...
        'modified' => [
            ...
            'idarea' => 'ID Área foi alterado de: <strong>:old</strong> para: <strong>:new</strong>',
            'disciplina' => 'Disciplina foi alterado de: <strong>:old</strong> para: <strong>:new</strong>',
        ],
    ],
